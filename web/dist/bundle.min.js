...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n// Copyright (c) Microsoft Corporation. All rights reserved.\n// Licensed under the MIT License.\n\n//# sourceMappingURL=onnx-value.js.map\n\n//# sourceURL=webpack://yolox-onnx-test/./node_modules/onnxruntime-common/dist/lib/onnx-value.js?");
...
eval("const ort = __webpack_require__(/*! onnxruntime-web */ \"./node_modules/onnxruntime-web/dist/ort-web.min.js\");\nconst modelFile = __webpack_require__(/*! ../models/yolox_nano_416x416.onnx */ \"./models/yolox_nano_416x416.onnx\");\nasync function main() {\n    try {\n        const session = await ort.InferenceSession.create(modelFile);\n\n        const start = performance.now();\n        let results = \"\";\n        const im = Float32Array.from(Array(1 * 3 * 416 * 416).fill(0));\n        const tensorIm = new ort.Tensor(\"float32\", im, [1, 3, 416, 416]);\n        const feeds = { images: tensorIm };\n        for (let i = 0; i < 10; i++) {\n            results = await session.run(feeds);\n        }\n        const end = performance.now();\n\n        console.log(results);\n        document.write(`fin. Avr. ${((end - start) / 10).toFixed(2)}msec`);\n    } catch (e) {\n        document.write(`failed to inference ONNX model: ${e}.`);\n    }\n}\n\nmain();\n\n\n//# sourceURL=webpack://yolox-onnx-test/./web/main.js?");

/***/ }),

/***/ "./models/yolox_nano_416x416.onnx":
/*!****************************************!*\
  !*** ./models/yolox_nano_416x416.onnx ***!
  \****************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
"use strict";
eval("module.exports = __webpack_require__.p + \"9631aa2af65fb524e08b.onnx\";\n\n//# sourceURL=webpack://yolox-onnx-test/./models/yolox_nano_416x416.onnx?");
...
/******/ 	var __webpack_exports__ = __webpack_require__("./web/main.js");
/******/ 	
